...
public class RunAfterStartup {
    ...
    public void runAfterStartup() {
        ...
        eventA.setDateTime(LocalDateTime.of(LocalDate.of(2023,04,05),LocalTime.of(10,0,0)));
        eventA.setCreatorId(userA.getId());
        eventA.setTags(tags);

        Event savedEvent = eventService.saveEvent(eventA);
